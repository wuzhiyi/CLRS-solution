 ...
 * One structure to fit a matrix and a submatrix.
 */
struct matrix {
    int x;
    int y;
...
void strassen(matrix C, matrix A, matrix B)
{
    ...
    if (A.size==1) {
        ...
        matrix b11=submatrix(A,   0,   0,half);
        matrix b12=submatrix(A,   0,half,half);
        matrix b21=submatrix(A,half,   0,half);
        matrix b22=submatrix(A,half,half,half);
        
        matrix c11=submatrix(A,   0,   0,half);
        matrix c12=submatrix(A,   0,half,half);
        matrix c21=submatrix(A,half,   0,half);
        matrix c22=submatrix(A,half,half,half);
